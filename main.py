...
def attack(char_name: str, char_class: str) -> str:
    """Урон от атаки в зависимости от класса."""
    ...
    return (
        f'{char_name} нанёс урон противнику '
        f'равный q{5 + randint(-3, -1)}')


def defence(char_name: str, char_class: str) -> str:
    """Блокирование урона в зависимости от класса."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Использование специальных умений в зависимости от класса."""
    if char_class == 'warrior':
        return (
    ...
    while approve_choice != 'y':
        ...
        if char_class == 'healer':
            print(
                ...
                'Черпает силы из природSelectы, веры и духов.')
